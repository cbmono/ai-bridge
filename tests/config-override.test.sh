...
# The tick's dispatch step is its own file since ai-bridge-v3/task-024.
for f in "$TPL/plugin/skills/dispatch/SKILL.md" "$TPL/plugin/tick-steps/step-3-dispatch.md"; do
