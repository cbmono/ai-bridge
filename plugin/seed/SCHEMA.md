...
last_blocker: "<what the last round ended on>"   # PM-OWNED, NEVER HAND-EDITED. The blocker text or failing check the counter is counting, whitespace folded to one line. Absent ⇒ none.
