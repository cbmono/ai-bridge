...
## Reference
* Awaiting you — `AWAITING.md` **if present**: what needs a human decision (approve · answer · merge · unblock · close), rewritten each `/ai-bridge:dispatch` tick. Absent means the queue is turned off
